      ...
      <View style={styles.bottomContent}>
        ...
        <View style={styles.form}>
          ...
          <TextInput
            ...
            outlineStyle={styles.inputOutline}
          />
          <Button title="Submit" onPress={handleSubmit} radius="lg" />
        </View>
        <Text style={styles.policy}>Don't have an account?<Pressable onPress={handleSwitch} style={{alignSelf: "center", justifySelf: "center"}}><Text style={styles.lined}> SignUp</Text></Pressable></Text>
