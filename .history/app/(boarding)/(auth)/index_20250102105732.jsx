    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomContent}>
        <Text style={styles.or}>
          Regis Sign In and we'll get started.
        </Text>
        ...
        <Text style={styles.policy}>Don't have an account?<Pressable onPress={handleSwitch} ><Text style={styles.lined}> SignUp</Text></Pressable></Text>
