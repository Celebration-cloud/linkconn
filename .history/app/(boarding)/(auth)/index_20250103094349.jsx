...
const LoginScreen = () => {
  ...
  return (
    <ScrollView>
      <Themed style={styles.container}>
        <Themed style={styles.company}>
          <Themed style={styles.imageContainer}>
            <Image
              style={styles.image}
              resizeMode="cover"
        ...
        <Themed style={styles.bottomContent}>
              ...
              render={({ field: { onChange, value } }) => (
                <Themed>
                  ...
                  <RadioButton.Group onValueChange={onChange} value={value}>
                    <Themed style={styles.mode}>
                      <Themed style={styles.radioContainer}>
          ...
          <Themed style={styles.groupBtn}>
            {loginOptions.map((loginOptions, idx) => (
              <Themed key={idx} style={styles.loginOptBtn}>
                <Button
