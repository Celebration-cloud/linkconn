...
const LoginScreen = () => {
  ...
  return (
    <ScrollView>
      <ThemedVi style={styles.container}>
        <ThemedVi style={styles.company}>
          <ThemedVi style={styles.imageContainer}>
            <Image
              style={styles.image}
              resizeMode="cover"
        ...
        <ThemedVi style={styles.bottomContent}>
              ...
              render={({ field: { onChange, value } }) => (
                <ThemedVi>
                  ...
                  <RadioButton.Group onValueChange={onChange} value={value}>
                    <ThemedVi style={styles.mode}>
                      <ThemedVi style={styles.radioContainer}>
          ...
          <ThemedVi style={styles.groupBtn}>
            {loginOptions.map((loginOptions, idx) => (
              <ThemedVi key={idx} style={styles.loginOptBtn}>
                <Button
