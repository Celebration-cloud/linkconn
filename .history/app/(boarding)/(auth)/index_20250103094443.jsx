...
import { Pressable, ScrollView, StyleSheet, ThemeText, View } from 'react-native';
      ...
      <ThemedView style={styles.container}>
        <ThemedView style={styles.company}>
          ...
          <ThemedView style={styles.details}>
            <ThemeText style={styles.title}>LINKCONN</ThemeText>
            <ThemeText style={styles.subTitle}>Welcome to Linkconn</ThemeText>
          </ThemedView>
        </ThemedView>

        <ThemedView style={styles.bottomContent}>
          <ThemeText style={styles.or}>Sign In</ThemeText>
          <ThemedView style={styles.form}>
            <ThemedView>
              ...
              />
              {errors.email && (
                <ThemeText style={styles.errorText}>{errors.email.message}</ThemeText>
              )}
            </ThemedView>
            ...
            <ThemedView>
              ...
              />
              {errors.password && (
                <ThemeText style={styles.errorText}>{errors.password.message}</ThemeText>
              )}
            </ThemedView>
            <Controller
              control={control}
              ...
              render={({ field: { onChange, value } }) => (
                <ThemedView>
                  <ThemeText>Select Mode:</ThemeText>
                  <RadioButton.Group onValueChange={onChange} value={value}>
                    <ThemedView style={styles.mode}>
                      ...
                      <ThemedView style={styles.radioContainer}>
                        ...
                        <ThemeText>Agent</ThemeText>
                      </ThemedView>
                    </ThemedView>
                  </RadioButton.Group>
                  {errors.mode && (
                    <ThemeText style={styles.errorText}>{errors.mode.message}</ThemeText>
                  )}
                </ThemedView>
              )}
              name="mode"
            ...
            <Button
              ...
              radius="lg"
            />
            <ThemeText style={styles.policy}>
              Don't have an account?
              <Pressable onPress={handleSwitch}>
                <ThemeText style={styles.lined}> SignUp</ThemeText>
              </Pressable>
            </ThemeText>
          </ThemedView>
            ...
            {loginOptions.map((loginOptions, idx) => (
              <ThemedView key={idx} style={styles.loginOptBtn}>
                ...
                >
                  ...
                  <ThemeText style={styles.loginOptText}>{loginOptions.title}</ThemeText>
                </Button>
              </ThemedView>
            ))}
          </ThemedView>
