      ...
      <ThemedView style={styles.container}>
        <ThemedView style={styles.company}>
          ...
          <ThemedView style={styles.details}>
            <ThemeT style={styles.title}>LINKCONN</ThemeT>
            <ThemeT style={styles.subTitle}>Welcome to Linkconn</ThemeT>
          </ThemedView>
        </ThemedView>

        <ThemedView style={styles.bottomContent}>
          <ThemeT style={styles.or}>Sign In</ThemeT>
          <ThemedView style={styles.form}>
            <ThemedView>
              ...
              />
              {errors.email && (
                <ThemeT style={styles.errorText}>{errors.email.message}</ThemeT>
              )}
            </ThemedView>
            ...
            <ThemedView>
              ...
              />
              {errors.password && (
                <ThemeT style={styles.errorText}>{errors.password.message}</ThemeT>
              )}
            </ThemedView>
            <Controller
              control={control}
              ...
              render={({ field: { onChange, value } }) => (
                <ThemedView>
                  ...
                  {errors.mode && (
                    <ThemeT style={styles.errorText}>{errors.mode.message}</ThemeT>
                  )}
                </ThemedView>
              )}
              name="mode"
            ...
            <Button
              ...
              radius="lg"
            />
            <ThemeT style={styles.policy}>
              Don't have an account?
              <Pressable onPress={handleSwitch}>
                <ThemeT style={styles.lined}> SignUp</ThemeT>
              </Pressable>
            </ThemeT>
          </ThemedView>
            ...
            {loginOptions.map((loginOptions, idx) => (
              <ThemedView key={idx} style={styles.loginOptBtn}>
                ...
                >
                  ...
                  <ThemeT style={styles.loginOptText}>{loginOptions.title}</ThemeT>
                </Button>
              </ThemedView>
            ))}
          </ThemedView>
