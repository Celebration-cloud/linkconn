      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottomContent}>
          ...
          <View style={styles.form}>
            ...
            <Controller control={control} rules={{ required: 'Option is required' }} render={({ field: { onChange, value } }) => ( <View style={styles.radioContainer}> <RadioButton value="second" status={value === "second" ? "checked" : "unchecked"} onPress={() => onChange("second")} /> <Text>Option Two</Text> </View> )} name="option" />
            <Button
              title="Submit"
