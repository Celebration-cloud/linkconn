      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottomContent}>
          ...
          <View style={styles.form}>
            <Controller control={control} rules={{ required: 'Full Name is required', minLength: { value: 3, message: 'Full Name must be at least 3 characters long' } }} render={({ field: { onChange, value } }) => ( <View> <Text>Full Name:</Text> <TextInput style={styles.input} onChangeText={onChange} value={value} placeholder="Enter your full name" /> {errors.fullName && ( <Text style={styles.errorText}>{errors.fullName.message}</Text> )} </View> )}
            <View>
              <Controller
                control={control}
                rules={{
            ...
            <View>
              ...
              />
              {errors.checked && (
                <Text style={{...styles.errorText, textAlign: "center"}}>{errors.checked.message}</Text>
              )}
            </View>
            <Button
              title="Submit"
