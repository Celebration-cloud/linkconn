...
import { Pressable, ScrollView, StyleSheet, Text, T } from "react-native";
    ...
    <ScrollView>
      <T style={styles.container}>
        ...
        <T style={styles.bottomContent}>
          ...
          <T style={styles.groupBtn}>
            {loginOptions.map((loginOptions, idx) => (
              <T key={idx} style={styles.loginOptBtn}>
                <Button
