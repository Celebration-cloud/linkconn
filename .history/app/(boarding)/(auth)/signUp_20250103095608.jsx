...
import { Pressable, ScrollView, StyleSheet, Text, The } from "react-native";
...
const LoginScreen = () => {
  ...
  return (
    <ScrollView>
      <The style={styles.container}>
        <The style={styles.company}>
          <The style={styles.imageContainer}>
            <Image
              style={styles.image}
              resizeMode="cover"
        ...
        <The style={styles.bottomContent}>
              ...
              render={({ field: { onChange, value } }) => (
                <The>
                  ...
                  <RadioButton.Group onValueChange={onChange} value={value}>
                    <The style={styles.mode}>
                      <The style={styles.radioContainer}>
          ...
          <The style={styles.groupBtn}>
            {loginOptions.map((loginOptions, idx) => (
              <The key={idx} style={styles.loginOptBtn}>
                <Button
