      ...
      <ThemedView style={styles.container}>
        <ThemedView style={styles.company}>
          ...
          <ThemedView style={styles.details}>
            <The style={styles.title}>LINKCONN</The>
            <The style={styles.subTitle}>Welcome to Linkconn</The>
          </ThemedView>
        </ThemedView>

        <ThemedView style={styles.bottomContent}>
          <The style={styles.or}>Register and we'll get started.</The>
          <ThemedView style={styles.form}>
            ...
            <ThemedView>
              ...
              />
              {errors.email && (
                <The style={styles.errorText}>{errors.email.message}</The>
              )}
            </ThemedView>
            ...
            <ThemedView>
              ...
              />
              {errors.password && (
                <The style={styles.errorText}>{errors.password.message}</The>
              )}
            </ThemedView>
            <Controller
              control={control}
              ...
              render={({ field: { onChange, value } }) => (
                <ThemedView>
                  ...
                  {errors.mode && (
                    <The style={styles.errorText}>{errors.mode.message}</The>
                  )}
                </ThemedView>
              )}
              name="mode"
            ...
            <ThemedView>
              <Controller
                ...
                render={({ field: { onChange, value } }) => (
                  <ThemedView style={styles.radioContainer}>
                    ...
                    />
                    <The style={styles.policy}>
                      I accept Linkconn{" "}
                      <The style={styles.lined}>Terms of Use</The> and{" "}
                      <The style={styles.lined}>Privacy Policy</The>
                    </The>
                  </ThemedView>
                )}
                name="checked"
              />
              {errors.checked && (
                <The style={{ ...styles.errorText, textAlign: "center" }}>
            ...
            <The style={styles.policy}>
              ...
              <Pressable onPress={handleSwitch}>
                <The style={styles.lined}> Login</The>
              </Pressable>
            </The>
          </ThemedView>
            ...
            {loginOptions.map((loginOptions, idx) => (
              <ThemedView key={idx} style={styles.loginOptBtn}>
                ...
                >
                  ...
                  {"   "}
                  <The style={styles.loginOptText}>{loginOptions.title}</The>
                </Button>
              </ThemedView>
            ))}
          </ThemedView>
