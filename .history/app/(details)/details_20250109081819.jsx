...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: 'bold', marginBottom: 16, }, image: { height: 200, width: 400, }, price: { fontSize: 18, fontWeight: 'bold', marginVertical: 8, }, address: { fontSize: 16, marginVertical: 4, }, description: { fontSize: 14, marginVertical: 4,},
