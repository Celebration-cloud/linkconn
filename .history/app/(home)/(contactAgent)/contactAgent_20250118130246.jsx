...
const ContactAgentScreen = () => {
  const [keyboardVisible, setKeyboardVisible] = useState(false);
   const [inputHeight, setInputHeight] = useState(40);
    ...
    useEffect(() => { 
      // Listener for inputHeight changes 
      console.log(`Input height changed to: ${inputHeight}`); 
      setInputHeight(inputHeight);
    }, [inputHeight, setInputHeight]);
    console.log(`Input height changed: ${inputHeight}`); 
  return (
    <ThemedView style={styles.container}>
      <KeyboardAvoidingView
        behavior={Platform.OS === "ios" ? "padding" : "height"}
        keyboardVerticalOffset={keyboardVisible && 160 + inputHeight -40}
