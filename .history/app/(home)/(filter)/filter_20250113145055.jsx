...
const RentFilters = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Slider value={priceRange[1]} maximumValue={10000} minimumValue={0} step={100} allowTouchTrack onValueChange={handleValueChange} thumbStyle={{ height: 20, width: 20, backgroundColor: 'blue' }} trackStyle={{ height: 10, backgroundColor: 'grey' }}/>
      </View>
