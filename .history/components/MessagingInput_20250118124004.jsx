    ...
    <KeyboardAvoidingView style={{bottom: 0}}>
       <View style={styles.container}>
        <View style={styles.innerContainer}>
          ...
          />
          <TextInput style={{...styles.input, height: inp}} placeholder="Type a message" onContentSizeChange={(event) => setInputHeight(event.nativeEvent.contentSize.height)}  multiline={true}/>
          <Icon
            name="camera"
            type="font-awesome"
            size={24}
