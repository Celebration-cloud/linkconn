...
import { StyleSheet, View, Theme } from 'react-native';
...
const ProfileCard = () => {
  return (
    <Card containerStyle={styles.card}>
      ...
      />
      <Theme style={styles.name}>Emma Grace</ThText>
      <Theme style={styles.title}>Partner</Theme>
      <Card.Divider/>
      <Theme style={styles.overview}>Overview</Theme>
      <Theme style={styles.description}>
